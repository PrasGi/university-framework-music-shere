<div id="music-player" class="music-player rounded-pill">
    ...
    <button id="close-music-btn" class="btn-outline-warning btn-music"><i class="mdi mdi-close"></i></button>
...
<button id="maximize-btn" class="btn btn-outline-warning text-light"><i class="mdi mdi-fullscreen"></i> Open
    Music</button>
